...
export function FinalCTASection() {
  ...
  return (
    <section id="cta-section" className="py-20 md:py-32 bg-primary text-primary-foreground relative overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 space-y-4">
            ...
            <p className="text-xl text-primary-foreground/90 text-pretty">
              Tenha acesso imediato ao planner completo e organize seu grande dia com tranquilidade
            </p>
          </div>
          ...
          <div className="bg-card text-card-foreground rounded-2xl p-8 md:p-12 shadow-2xl mb-8">
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-6 invisible md:visible">E mais:</h3>
                <ul className="space-y-3">
            ...
            <div className="mt-8 pt-8 border-t border-border text-center space-y-6">
              <div className="mb-6">
                ...
                <div className="text-5xl font-bold text-primary mb-2">R$ 19,90</div>
              ...
              <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground mt-4">
                ...
                <span>Ambiente 100% seguro - Seus dados estão protegidos com criptografia SSL</span>
              </div>
            </div>
          </div>
